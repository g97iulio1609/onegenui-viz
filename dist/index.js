...
__export(index_exports, {
  ...
  GanttPropsSchema: () => GanttPropsSchema,
  Graph: () => Graph,
  GraphDefinition: () => GraphDefinition,
  GraphPropsSchema: () => GraphPropsSchema,
  MindMap: () => MindMap,
  MindMapDefinition: () => MindMapDefinition,
  MindMapPropsSchema: () => MindMapPropsSchema,
  StockChart: () => StockChart,
  StockChartDefinition: () => StockChartDefinition,
  StockChartPropsSchema: () => StockChartPropsSchema
});
module.exports = __toCommonJS(index_exports);

// src/charts/Chart/component.tsx
var import_react = require("react");
var import_react2 = require("@onegenui/react");
...
var Chart = (0, import_react.memo)(function Chart2({
  element,
  children
}) {
  const { title, data, dataPath, height, series, categories } = element.props;
  const { data: globalData } = (0, import_react2.useData)();
  const chartData = (0, import_react.useMemo)(() => {
    ...
    return (0, import_utils.resolveArrayProp)(globalData, data, dataPath);
  }, [series, categories, globalData, data, dataPath]);
  const chartHeight = Math.max(height || DEFAULT_HEIGHT, MIN_HEIGHT);
  const { selectedItems, isItemSelected } = (0, import_react2.useItemSelection)(element.key);
  const [hoveredIndex, setHoveredIndex] = (0, import_react.useState)(null);
  const { ticks, normalizedData } = (0, import_react.useMemo)(() => {
...
// src/charts/Chart/schema.ts
var seriesSchema = import_zod.z.object({
  name: import_zod.z.string(),
  data: import_zod.z.array(import_zod.z.number()),
  color: import_zod.z.string().nullable()
});
var ChartPropsSchema = import_zod.z.object({
  title: import_zod.z.string().nullable(),
  data: import_zod.z.array(import_schemas.chartDatumSchema).nullable(),
  dataPath: import_zod.z.string().nullable(),
  height: import_zod.z.number().nullable(),
  // Multi-series support
  series: import_zod.z.array(seriesSchema).nullable(),
  categories: import_zod.z.array(import_zod.z.string()).nullable()
});
var ChartDefinition = {
  name: "Chart",
...
var StockChart = (0, import_react3.memo)(function StockChart2({
  element
}) {
  ...
  const seriesRef = (0, import_react3.useRef)(null);
  const [timeframe, setTimeframe] = (0, import_react3.useState)(
    props.timeframe || "3M"
  );
...
var ohlcSchema = import_zod2.z.object({
  time: import_zod2.z.string().describe("Date in YYYY-MM-DD format"),
  open: import_zod2.z.number().describe("Opening price"),
  high: import_zod2.z.number().describe("Highest price"),
  low: import_zod2.z.number().describe("Lowest price"),
  close: import_zod2.z.number().describe("Closing price"),
  volume: import_zod2.z.number().nullable().optional().describe("Trading volume")
});
var stockSeriesSchema = import_zod2.z.object({
  symbol: import_zod2.z.string().describe("Stock ticker symbol (e.g., AAPL, GOOGL)"),
  name: import_zod2.z.string().describe("Full company/instrument name"),
  color: import_zod2.z.string().describe("Hex color for the series line (e.g., #3b82f6)"),
  data: import_zod2.z.array(ohlcSchema).describe("Array of OHLC data points")
});
var technicalLevelSchema = import_zod2.z.object({
  price: import_zod2.z.number().describe("Price level"),
  type: import_zod2.z.enum(["support", "resistance"]).describe("Type of technical level"),
  strength: import_zod2.z.number().nullable().optional().describe("Strength indicator (0-1)"),
  label: import_zod2.z.string().nullable().optional().describe("Custom label for the level")
});
var timeframeSchema = import_zod2.z.enum(["1D", "1W", "1M", "3M", "1Y", "5Y", "10Y", "ALL"]).describe("Time period to display");
var StockChartPropsSchema = import_zod2.z.object({
  title: import_zod2.z.string().nullable().optional().describe("Chart title"),
  series: import_zod2.z.array(stockSeriesSchema).nullable().optional().describe("Array of stock series to display"),
  levels: import_zod2.z.array(technicalLevelSchema).nullable().optional().describe("Technical support/resistance levels"),
  chartType: import_zod2.z.enum(["Line", "Candlestick"]).nullable().optional().describe("Chart visualization type"),
  timeframe: timeframeSchema.nullable().optional().describe("Initial timeframe selection"),
  height: import_zod2.z.number().nullable().optional().describe("Chart height in pixels (default: 400)"),
  showLevels: import_zod2.z.boolean().nullable().optional().describe("Show support/resistance levels (default: true)"),
  showVolume: import_zod2.z.boolean().nullable().optional().describe("Show volume bars (default: false)")
});
...
var NodeRenderer = (0, import_react4.memo)(function NodeRenderer2({
  node,
  depth,
  isHorizontal,
  expandedByDefault,
  ...
  const [expanded, setExpanded] = (0, import_react4.useState)(expandedByDefault);
  ...
  const [paths, setPaths] = (0, import_react4.useState)([]);
  const updatePaths = (0, import_react4.useCallback)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { ref: nodeRef, className: "relative group z-10 flex items-center", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
            "div",
            {
              ...
              children: [
                node.icon && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-xl flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-lg bg-background/50 border border-white/10", children: node.icon }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex-1 min-w-0", children: [
                  ...
                  node.description && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "text-[11px] text-muted-foreground mt-1 leading-snug line-clamp-2", children: node.description })
                ] })
              ]
            }
          ),
        ...
        hasChildren && expanded && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-row items-stretch", children: [
          isHorizontal && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "w-16 relative shrink-0", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("svg", { className: "absolute top-0 left-0 w-full h-full overflow-visible pointer-events-none", children: paths.map((d, i) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            "path",
            {
              d,
              fill: "none",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            "div",
            {
              ...
              children: node.children.map((child) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                NodeRenderer2,
                {
                  node: child,
                  depth: depth + 1,
...
var MindMap = (0, import_react5.memo)(function MindMap2({
  element,
  children
}) {
  ...
  const rootNodes = (0, import_react5.useMemo)(() => {
...
var MindMapPropsSchema = import_zod3.z.object({
  title: import_zod3.z.string().nullable(),
  nodes: import_zod3.z.array(import_schemas.mindMapNodeSchema),
  layout: import_zod3.z.enum(["horizontal", "vertical"]).nullable(),
  expandedByDefault: import_zod3.z.boolean().nullable()
});
...
var EdgesRenderer = (0, import_react6.memo)(function EdgesRenderer2({
  edges,
  nodeStates
}) {
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: edges.map((e, i) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("g", { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      "line",
      {
        x1: u.pos.x,
        y1: u.pos.y,
...
var NodesRenderer = (0, import_react7.memo)(function NodesRenderer2({
  nodes,
  nodeStates,
  elementKey,
  isSelected,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_jsx_runtime6.Fragment, { children: nodes.map((n) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
      "g",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("circle", { r: s.size, fill: color, opacity: selected ? 0.2 : 0.1 }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
            "foreignObject",
            {
              x: -s.size * 1.5,
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "flex justify-center items-center h-full", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "px-1.5 py-0.5 rounded-md text-xs font-medium text-black border border-black/10 whitespace-nowrap shadow-sm bg-white/85", children: n.label }) })
            }
          )
        ]
      },
...
var Graph = (0, import_react8.memo)(function Graph2({
  element,
  children
}) {
  const {
  ...
  const nodes = (0, import_react8.useMemo)(
  ...
  const [dimensions, setDimensions] = (0, import_react8.useState)({ w: 800, h: DEFAULT_H });
  const nodeStates = (0, import_react8.useRef)(/* @__PURE__ */ new Map());
  const rafRef = (0, import_react8.useRef)(void 0);
  const [bump, setBump] = (0, import_react8.useState)(0);
  const iterationCount = (0, import_react8.useRef)(0);
  const { isSelected, toggleSelection } = (0, import_react9.useSelection)();
  ...
  const dragNodeId = (0, import_react8.useRef)(null);
  ...
  const handleWheel = (0, import_react8.useCallback)((e) => {
    e.stopPropagation();
    const d = e.deltaY > 0 ? 0.9 : 1.1;
    setZoom((z6) => Math.max(0.1, Math.min(5, z6 * d)));
  }, []);
  const handlePointerDown = (0, import_react8.useCallback)((e) => {
    e.stopPropagation();
  ...
  const handlePointerUp = (0, import_react8.useCallback)((e) => {
    e.stopPropagation();
    e.currentTarget.releasePointerCapture(e.pointerId);
    isDragging.current = false;
    dragNodeId.current = null;
  }, []);
  const handleNodeDragStart = (0, import_react8.useCallback)(
    (nodeId, e) => {
      isDragging.current = true;
  ...
  const renderedEdges = (0, import_react8.useMemo)(
    () => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(EdgesRenderer, { edges, nodeStates: nodeStates.current }),
    [edges, bump]
  );
  const renderedNodes = (0, import_react8.useMemo)(
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
          "svg",
          {
            ...
            className: "block",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("defs", { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
                "marker",
                {
                  id: "arrow",
                  viewBox: "0 0 10 10",
                  ...
                  markerHeight: "6",
                  orient: "auto",
                  children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("path", { d: "M 0 0 L 10 5 L 0 10 z", fill: "var(--muted-foreground)" })
                }
              ) }),
              /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("g", { transform: `translate(${pan.x}, ${pan.y}) scale(${zoom})`, children: [
                renderedEdges,
                renderedNodes
              ] })
            ]
...
var GraphPropsSchema = import_zod4.z.object({
  title: import_zod4.z.string().nullable(),
  nodes: import_zod4.z.array(import_schemas.graphNodeSchema).nullable(),
  edges: import_zod4.z.array(import_schemas.graphEdgeSchema).nullable(),
  layout: import_zod4.z.enum(["force", "radial", "grid"]).nullable(),
  showLabels: import_zod4.z.boolean().nullable(),
  showEdgeLabels: import_zod4.z.boolean().nullable(),
  allowPanZoom: import_zod4.z.boolean().nullable(),
  width: import_zod4.z.number().nullable(),
  height: import_zod4.z.number().nullable(),
...
var Gantt = (0, import_react10.memo)(function Gantt2({
  element,
  children
}) {
                    ...
                    "div",
                    {
                      ...
                      children: isMilestone ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
                        ...
                        "div",
                        {
                          ...
                          children: [
                            width > 10 && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { className: "z-[2]", children: [
                              task.progress,
                              "%"
                            ] }),
                            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
...
var GanttPropsSchema = import_zod5.z.object({
  title: import_zod5.z.string().nullable(),
  tasks: import_zod5.z.array(import_schemas.ganttTaskSchema).min(1).describe("Tasks (REQUIRED, min 1)"),
  lock: import_zod5.z.boolean().nullable()
});
var GanttDefinition = {
  name: "Gantt",
